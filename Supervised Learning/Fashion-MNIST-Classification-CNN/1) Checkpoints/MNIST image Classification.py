...
#%%
#setting checkpoints
checkpts = keras.callbacks.ModelCheckpoint("Model Saves/Model-{epoch:02d}.h5")
#%%
#training
model_history = model.fit(X_train, Y_train, epochs=30, batch_size=64, validation_data=(X_valid, Y_valid), callbacks=[checkpts])
#%%
